...
interface AcademicAdminSidebarProps {
  isOpen: boolean;
  onToggle: () => void;
}

const AcademicAdminSidebar: React.FC<AcademicAdminSidebarProps> = ({ isOpen, onToggle }) => {
...
const menuItems = [
  ...
  { path: '/academic-admin-dashboard/course-assignment', icon: Send, label: 'Course Assignment', color: 'text-emerald-500' },
      ...
      >
        ...
        <div className="p-4 md:p-6 border-b">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg md:text-xl font-bold text-gray-800">Academic Admin</span>
          </div>
