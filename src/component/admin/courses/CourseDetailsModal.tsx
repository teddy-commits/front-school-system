...
import { 
  X, BookOpen, Clock, Users, Calendar, MapPin, 
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium">{course.enrolledStudents} / {course.maxStudents}</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium">{course.prerequisites || 'None'}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-medium text-gray-800">{course.instructorName || 'Not Assigned'}</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3 className="text-md font-semibold text-gray-800 mb-2">Department</h3>
              <p className="text-gray-600">{course.department || 'Not specified'}</p>
            </div>
            <div>
              <h3 className="text-md font-semibold text-gray-800 mb-2">Faculty</h3>
              <p className="text-gray-600">{course.faculty || 'Not specified'}</p>
            </div>
          </div>
