...
import { X, Users, Mail, User, Phone } from 'lucide-react';
...
const CourseEnrollmentModal: React.FC<CourseEnrollmentModalProps> = ({ course, onClose }) => {
  ...
  const fetchEnrollments = async () => {
    setIsLoading(true);
    try {
      const result = await enrollmentApi.getCourseEnrollments(course.courseCode);
      if (result.success) {
